/* Metode Numerik
	Nama		: Fazrin Mulyawan dan Ferry Rizki Setiawan
	NIM			: 3411151074 & 3411151100
	Kelas		: SIE-B
...
int main(){
   ...
   /*algoritma*/
   Home:
   printf("Perhitungan perkiraan lama waktu antar makanan mamah dedeh cibeber \n\n");
